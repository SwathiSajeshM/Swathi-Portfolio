 ...
 function Footer() {
  ...
  return (      
    ...
    <div className="bg-gradient-to-tr from-black via-[#04040F]  to-black  text-white py-7  px-8 text-center ">     
          ...
          <button 
  onClick={() => window.open('https://wa.me/918921225912', '_blank')} 
  className="inline-flex items-center gap-2 bg-[#d1ff1a] hover:bg-[#b8e617] text-black px-6 py-3 rounded-full transition-colors"
>
  Let's Talk <IoMdCall className="w-4 h-4" /> 
</button>
